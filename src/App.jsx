    ...
    <div key={appKey} className="app-container" style={{ position: 'relative' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <h2 style={{ fontSize: '1.6rem', fontWeight: '800', letterSpacing: '-0.03em', color: 'white' }}>
            Elect<span style={{ color: 'var(--primary)' }}>Guide</span>
          </h2>
        </div>

        <nav style={{ display: 'flex', gap: '3rem', alignItems: 'center' }}>
          <button onClick={handleReset} style={{ background: 'none', border: 'none', color: 'var(--text-secondary)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.9rem', fontWeight: '600' }}>
          ...
          <button className="btn-primary" style={{ borderRadius: '100px', display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      {/* Main Content */}
      <main style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 4rem' }}>
        ...
        <section style={{
          ...
          >
            ...
            <h1 style={{ fontSize: 'clamp(3rem, 8vw, 6rem)', lineHeight: '1', fontWeight: '900', letterSpacing: '-0.05em', marginBottom: '2rem', color: 'white' }}>
              Democracy, <br />
        ...
        <section id="interactive" style={{ padding: '8rem 0' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12rem' }}>
            ...
            <div id="step5">
              ...
              <ResultVisualizer votesData={votesData} />
            </div>
          </div>
        </section>

        <section id="timeline" style={{ padding: '8rem 0' }}>
          <Timeline />
        </section>

      </main>

      <footer style={{ padding: '6rem 4rem', borderTop: '1px solid var(--border)', textAlign: 'center', background: 'rgba(2, 6, 23, 0.5)' }}>
